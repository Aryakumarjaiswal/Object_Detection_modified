...
from ..models import MediaUpload,MaintenanceCheck, DetectionResults, DetectedObjects
...
async def process_maintenance_check(file_path, media_type, task_id, db: Session):
    try:
        ...
        fin_response_json={"Status":status_val,"general_description":response_json["general_description"],"image_path": bounding_img["image_path"]}
